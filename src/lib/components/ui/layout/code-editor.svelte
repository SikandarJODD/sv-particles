...
<div class="flex flex-col sm:min-h-[36rem] sm:flex-row">
	<div
		class="w-full border-b bg-neutral-50 text-black [--color-background:var(--color-zinc-900)] [--color-foreground:white] [--color-muted:var(--color-zinc-800)] sm:w-64 sm:border-r sm:border-b-0 dark:bg-zinc-900/25 dark:text-white"
	>
	...
	<div class="relative min-h-[32rem] min-w-0 flex-1">
		<div class="flex items-center justify-between gap-3 border-b py-1.5 pr-2 pl-4">
			<div class="min-w-0 truncate font-mono text-sm tracking-wider text-muted-foreground">
				<span class="flex items-center gap-1">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="16"
